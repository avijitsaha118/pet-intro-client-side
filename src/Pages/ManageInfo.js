...
const ManageInfo = () => {
    ...
    return (
        <div className='w-50 mx-auto'>
                    ...
                    <Table responsive="sm" striped bordered hover>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><button className='btn btn-danger' onClick={() => handleDelete(information._id)}><i><FontAwesomeIcon icon={faTrash} /></i> Delete</button></td>
            ...
            <button className='btn btn-secondary mt-5' onClick={navigateAddNew}>Add New Pet</button>
